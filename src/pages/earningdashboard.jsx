...
const PAYMENT_STATUS_META = {
  ...
  authorized: { label: 'Pending release', icon: Clock, className: 'bg-lavender/15 text-deep-purple' },
  pending: { label: 'Pending', icon: Clock, className: 'bg-lavender/15 text-deep-purple' },
  refunded: { label: 'Refunded', icon: XCircle, className: 'bg-jet-black/10 text-jet-black/50' },
    ...
    <div className="min-h-screen bg-soft-white pb-16">
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-8 sm:px-10">
          ...
          {loading ? (
            <p className="mt-8 text-center text-sm text-jet-black/40">Loading your stats…</p>
          ) : (
            <>
                      ...
                      return (
                        ...
                        >
                          <div>
                            ...
                            <p className="text-xs text-jet-black/45">Rental payment</p>
                          </div>
