...
function FileSlot({ id, label, hint, file, onPick, onClear, required }) {
  ...
  return (
    <div>
      <label htmlFor={id} className="mb-1 block text-sm font-medium text-jet-black">
        {label} {!required && <span className="font-normal text-jet-black/40">(optional)</span>}
      </label>
      {file ? (
        <div className="relative aspect-4/3 overflow-hidden rounded-xl border border-lavender/20 bg-jet-black/5">
        ...
        <button
          ...
          className="flex aspect-4/3 w-full flex-col items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-lavender/25 text-jet-black/40 transition hover:border-lavender hover:bg-lavender/5 hover:text-deep-purple"
        >
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-8 sm:px-10">
          ...
          {reasonLabel && verificationStatus !== 'verified' && (
            <div className="mt-5 rounded-2xl border border-lavender/25 bg-lavender/5 p-4 text-sm text-jet-black/70">
          ...
          <section className="mt-6 rounded-2xl border border-lavender/15 bg-white p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <ShieldCheck
                  className={`h-8 w-8 ${verificationStatus === 'verified' ? 'text-deep-purple' : 'text-jet-black/20'}`}
                />
                <div>
          ...
          {canSubmit && (
            <form onSubmit={handleSubmit} className="mt-4 rounded-2xl border border-lavender/15 bg-white p-6">
              <p className="font-display text-sm font-semibold text-jet-black">
              ...
              <div className="mt-4">
                <span className="mb-2 block text-sm font-medium text-jet-black">Document type</span>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-deep-purple px-5 py-3 text-sm font-semibold text-white transition hover:bg-deep-purple/90 disabled:opacity-50"
              >
