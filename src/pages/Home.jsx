        ...
        {menuOpen && (
          <div className="flex flex-col gap-1 border-t border-border px-6 py-4 md:hidden">
            ...
            <div className="mt-2 flex flex-col gap-2 border-t border-border pt-3">
              <Link to="/login" className="cta-outline rounded-xl px-5 py-[9px] text-center text-sm font-semibold">
                Log in
              </Link>
        ...
        <section className="border-b border-border">
          <div className="mx-auto grid max-w-6xl md:grid-cols-2">
            ...
            <div id="hosting" className="scroll-mt-20 border-t border-border px-6 py-16 sm:px-10 md:border-l md:border-t-0 lg:py-20">
              ...
              <Link
                to="/become-host"
                className="cta-outline mt-8 inline-block rounded-xl px-6 py-[11px] text-sm font-semibold"
              >
                Start hosting
              </Link>
            </div>
        ...
        <section className="brand-field px-6 py-16 sm:px-10 lg:py-20">
          <div className="mx-auto flex max-w-6xl flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex shrink-0 flex-wrap gap-3">
              <Link
                to="/explore"
                className="cta-outline rounded-xl px-6 py-[11px] text-sm font-bold"
              >
                Browse items
              </Link>
              <Link
