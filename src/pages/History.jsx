                      ...
                      {confirmCancelId === row.id ? (
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            disabled={cancelling}
                            className="rounded-full border border-white/30 bg-red-500/80 backdrop-blur-md px-3 py-1 text-xs font-semibold text-white shadow-[0_8px_24px_-10px_rgba(239,68,68,0.55)] transition hover:bg-red-500/90 disabled:opacity-50"
                          >
