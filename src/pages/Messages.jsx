      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-8 sm:px-10">
          ...
          {error ? (
            ...
            <p className="py-20 text-center text-sm text-jet-black/40">Loading conversations…</p>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {lastMessage && (
                          <span className="shrink-0 text-xs text-jet-black/40">{timeAgo(lastMessage.created_at)}</span>
                        )}
                      </div>
